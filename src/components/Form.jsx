...
export function Form({ title, body, category, categories, handlePostSubmit, handleUpdateSubmit, setTitle, setBody, image, setImage, setCategory, isUpdate, imageName,btnText}) {
    ...
    // console.log(body)
    return (
        <div className="border bg-amber-500 rounded-md text-white sm:w-[80%] w-full h-auto p-3 flex flex-col gap-3 shadow-xl shadow-black">
            ...
            <form onSubmit={isUpdate ? handleUpdateSubmit : handlePostSubmit} className="border flex flex-col items-center h-auto w-full gap-4 bg-blue-800 p-4 rounded-2xl">
                ...
                <div className="w-full overflow-auto" >
                    ...
                    <ReactQuill ref={quillRef} placeholder='Write Amazing Somthing...' className='bg-white text-black h-[200px] sm:h-[300px] overflow-hidden' theme="snow" value={body || ''} onChange={setBody} />
                </div>
