    ...
    return (
        <>
            <div className="main grid grid-cols-12 min-h-screen gap-3 bg-amber-600 overflow-auto">
                <div className="left-box bg-white col-span-12 sm:col-span-10 pt-[70px] flex flex-col p-3  gap-4 h-full">
                    ...
                    <div className="comment-main w-full flex flex-col gap-4 p-2 mt-auto bg-blue-600 mx-auto text-white">
                        ...
                        <form onSubmit={commentPost} className="flex gap-4">
                            <input type="text" value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Write Something..." className="w-[85%]  py-1 px-2 bg-white text-black"></input>
                            <button type="submit" className="w-[15%]  font-semibold bg-green-700">Post</button>
                        </form>
                        {singlePost.comments?.map((comment) => {
                            return (<div key={comment.id} className="flex gap-4">
                                <div className="comment-section break-words whitespace-normal w-[85%]  p-2 text-justify font-semibold bg-amber-600 ">
                                    <h1>{comment.content}</h1>
                                </div>
                                <div className="user-section  w-[15%] p-2 flex items-center justify-center font-semibold bg-red-600">
                ...
                <div className="right-box col-span-12 sm:col-span-2 bg-white  p-2 pt-[65px] h-full">
