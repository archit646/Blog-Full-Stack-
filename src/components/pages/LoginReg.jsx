        ...
        <>
            <div className="h-screen grid grid-cols-12 pt-[62px]">
                <div className="col-span-6">
                    <img className=" w-full h-full object-cover" src="https://static.vecteezy.com/system/resources/previews/028/046/128/non_2x/users-access-emails-from-multiple-devices-vector.jpg"></img>

                </div>
                <div className="col-span-6 flex justify-center items-center flex-col gap-10 bg-gray-600">
                    <div className="options-container flex border-b-1 w-full justify-center pb-1 gap-5 text-white">
                        <button className={`flex justify-center items-center cursor-pointer font-semibold px-4 py-1 ${active == 'login' ? 'border-b-5 border-white' : 'border-none'}`} onClick={() => setActive('login')}>Login</button>
                        <button className={`flex justify-center items-center cursor-pointer font-semibold px-4 py-1 ${active == 'register' ? 'border-b-5 border-white' : 'border-none'}`} onClick={() => setActive('register')}>Register</button>
                    </div>
                    <div className="form-container w-[70%] h-[80%] p-3 bg-white rounded-2xl">
                        {active == 'login'
                            ? <form action="" className="login-form flex flex-col gap-5 p-3">
                                <div className="row">
                            ...
                            : <form action="" className="register-form flex flex-col gap-5 p-3 bg-white rounded-2xl">
                                <div className="row">
