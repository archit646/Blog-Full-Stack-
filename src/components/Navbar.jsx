        ...
        <div className="relative w-full">
            <div className="navbar fixed w-full flex items-center justify-around sm:justify-around bg-amber-400 top-0 z-50">
                ...
                <div className="auth-btn sm:flex gap-5 hidden">
                    ...
                    {user
                        ?
                        <button className="border text-center font-bold text-3xl w-[45px] h-[45px] flex justify-center cursor-pointer  rounded-full bg-violet-700 hover:bg-violet-900 text-white" onClick={() => setLog(!log)}>{user[0]}</button>
